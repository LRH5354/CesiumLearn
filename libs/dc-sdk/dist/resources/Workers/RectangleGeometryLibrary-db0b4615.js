define([
  ...
  function R(t, n, a, r, e, o, s) {
    var i = Math.cos(n),
      ...
      u = r * h,
      C = a * h
    ;(p = x.project(t, p)), (p = Y.Cartesian3.subtract(p, G, p))
    i = l.Matrix2.fromRotation(n, d)
    ;(p = l.Matrix2.multiplyByVector(i, p, p)),
      (p = Y.Cartesian3.add(p, G, p)),
      --o,
      --s
    ;(r = (t = x.unproject(p, t)).latitude),
      (a = r + o * C),
      (h = r - c * s),
      (n = r - c * s + o * C),
      (i = Math.max(r, a, h, n)),
  ...
  ;(r.computeOptions = function (t, n, a, r, e, o, s) {
    ...
    return (
      ...
      0 !== r &&
        ((a -= r),
        (M = R((s = Y.Rectangle.northwest(e, s)), a, S, w, 0, l, M)),
