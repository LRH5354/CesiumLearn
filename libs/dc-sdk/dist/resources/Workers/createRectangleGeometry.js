define([
  ...
  './RectangleGeometryLibrary-db0b4615',
], function (
  Q,
  t,
  W,
  ...
  function mt(t, e) {
    ...
    for (
      var m = a.position ? new Float64Array(3 * t) : void 0,
        d = a.st ? new Float32Array(2 * t) : void 0,
        p = 0,
        g = 0,
        y = nt,
        f = I,
    ...
    if (
      ...
      for (var w = 0; w < d.length; w += 2)
        (d[w] = (d[w] - h) / (v - h)), (d[w + 1] = (d[w + 1] - b) / (_ - b))
    ;(l = (function (t, e, a, r) {
      var n = t.length,
      ...
      if (e.normal || e.tangent || e.bitangent)
        for (var d = 0; d < n; d += 3) {
          var p = J.Cartesian3.fromArray(t, d, nt),
            g = l + 1,
            y = l + 2,
  ...
  function y(t, e) {
    ...
    var m = rt.PolygonPipeline.scaleToGeodeticHeight(
      ...
      d = 2 * (U = (m = new Float64Array(m)).length),
    ...
    p.set(g, U), (c.attributes.position.values = p)
    var y,
      f,
      h,
      b = n.normal ? new Float32Array(d) : void 0,
      t = n.tangent ? new Float32Array(d) : void 0,
      o = n.bitangent ? new Float32Array(d) : void 0,
      i = n.st ? new Float32Array((d / 3) * 2) : void 0
    if (n.normal) {
    ...
    if (a) {
      ...
      for (var v = new Float32Array(d), _ = 0; _ < U; _++) f[_] = -f[_]
      v.set(f, U),
    ...
    var x = c.indices,
      w = x.length,
      C = U / 3,
      R = $.IndexDatatype.createTypedArray(d / 3, 2 * w)
      ...
      if (e.normal || e.tangent || e.bitangent)
        for (var g = 0; g < r; g += 6) {
          ...
          c &&
            ...
            (p = J.Cartesian3.normalize(J.Cartesian3.cross(y, h, p), p)),
            (c = !1)),
            ...
            (e.tangent || e.bitangent) &&
              ...
              e.tangent &&
                (d = J.Cartesian3.normalize(J.Cartesian3.cross(m, p, d), d))),
            e.normal &&
              ((n[s++] = p.x),
              (n[s++] = p.y),
              (n[s++] = p.z),
    ...
    var H,
      z,
      B = $.IndexDatatype.createTypedArray(l, 6 * d),
      U = F.length / 3,
      Y = 0
    for (_ = 0; _ < U - 1; _ += 2) {
      z = ((H = _) + 2) % U
  ...
  function c(t, e, a, r, n) {
    ...
    var i = S.RectangleGeometryLibrary.computeOptions(t, e, a, 0, d, f),
      t = i.height,
      e = i.width,
      a = u
    return (
      ...
      return (
        ...
        (c = n
          ? ((u = y(t, o)),
            ...
            (l = N.BoundingSphere.fromRectangle3D(e, a, m, p)),
