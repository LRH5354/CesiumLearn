define([
...
], function (c, e, d, s, p, t, i, b, _, v, E, f, a, g, A) {
  'use strict'
  var h = new p.BoundingSphere(),
    y = new p.BoundingSphere(),
    G = new s.Cartesian3(),
    m = new s.Rectangle()
  function R(e, t) {
    var i = e._ellipsoid,
    ...
    for (
      var o = (d.length / 3) * 2,
        h = E.IndexDatatype.createTypedArray(d.length / 3, o),
        y = 0,
        m = 0;
      m < d.length / 3 - 1;
      m++
  ...
  function P(e) {
    var t = (e = c.defaultValue(e, c.defaultValue.EMPTY_OBJECT)).rectangle,
      i = c.defaultValue(e.granularity, d.CesiumMath.RADIANS_PER_DEGREE),
  ...
  return (
    (P.createGeometry = function (e) {
      ...
      if (
        !d.CesiumMath.equalsEpsilon(t.north, t.south, d.CesiumMath.EPSILON10) &&
        !d.CesiumMath.equalsEpsilon(t.east, t.west, d.CesiumMath.EPSILON10)
      ) {
        var r,
          n,
          o,
          ...
          s = e._extrudedHeight
        return (
          (u = !d.CesiumMath.equalsEpsilon(u, s, 0, d.CesiumMath.EPSILON2)
            ? ((n = (function (e, t) {
              ...
              (o = p.BoundingSphere.fromRectangle3D(t, i, u, y)),
              (s = p.BoundingSphere.fromRectangle3D(t, i, s, h)),
              p.BoundingSphere.union(o, s))
            : (((n = R(
                e,
                a
              ...
              p.BoundingSphere.fromRectangle3D(t, i, u))),
          new _.Geometry({
