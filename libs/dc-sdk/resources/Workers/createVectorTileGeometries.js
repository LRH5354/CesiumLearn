define([
  ...
  var l = new T.Cartesian3(),
    ...
    p = V.Matrix4.packedLength + T.Cartesian3.packedLength,
    b = T.Cartesian3.packedLength + 1,
    y = { modelMatrix: new V.Matrix4(), boundingVolume: new V.BoundingSphere() }
  function A(e, t) {
    var n = t * u,
  ...
  return d(function (e, t) {
    var n = S.defined(e.boxes) ? new Float32Array(e.boxes) : void 0,
      ...
      p = M.BoxGeometry.getUnitBox(),
      b = B.CylinderGeometry.getUnitCylinder(),
