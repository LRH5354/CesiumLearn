define([
  ...
  var s = new Oe.Cartesian3(),
    ...
    Se = {}
  function g(e) {
    Oe.Cartographic.fromRadians(e.east, e.north, 0, p[0]),
      Oe.Cartographic.fromRadians(e.west, e.north, 0, p[1]),
      Oe.Cartographic.fromRadians(e.east, e.south, 0, p[2]),
      Oe.Cartographic.fromRadians(e.west, e.south, 0, p[3])
    for (
      ...
      for (var o = !1, l = 0; l < 4; ++l) {
        var u = p[l]
        if ((d.positionToTileXY(u, s, h), 0 === l)) (n = h.x), (i = h.y)
        else if (n !== h.x || i !== h.y) {
          o = !0
          break
        }
  ...
  w.createGeometry = function (e) {
    ...
    if (
      ...
      if (
        ((x = o
          ? ((R = E[0]), J((A = Z(l, H, d, A)), L, S, (I = Z(l, R, d, I)), x))
          : W(H, z, p, l, x)),
        (a = O.length),
        Oe.Cartesian3.pack(x, O, a),
        Oe.Cartesian3.pack(L, P, a),
        ...
        for (
          U(z, N, d, p, u, c, l, O, P, k, b), a = O.length, M = 0;
          M < 3;
          ++M
        )
        ...
        for (o = 0; o < h; o++) {
          ...
          H && (ee = Oe.Cartesian3.negate(ee, ee)),
            ...
            s &&
              ...
              (V = a.project(P, Ke)),
              ((de = xe((Y = a.project(k, $e)), V, ca)).y = Math.abs(de.y)),
              (F = ea),
              (q = aa),
              0 === Me || Oe.Cartesian3.dot(de, Oe.Cartesian3.UNIT_Y) > Ie
          ...
          var Me = Je,
            ...
            Te = Se.getMinimumMaximumHeights(le, p),
          ...
          ;(Q += le),
            ...
            De(K, $, le, Te, Me, re),
            De(B, j, le, Te, ie, ee)
          Te = Oe.Cartesian3.multiplyByScalar(se, be.CesiumMath.EPSILON5, da)
  ...
  var He = new Oe.Cartographic(),
    ...
    Ca = new Oe.Cartesian3(),
    da = new Oe.Cartesian3(),
    pa = [new Pe.BoundingSphere(), new Pe.BoundingSphere()],
    ha = [
      0,
      2,
      1,
