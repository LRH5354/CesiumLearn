define([
...
], function (n, e, t, o, m, r, a, i, u, p, c) {
  "use strict";
  function y(e) {
    e = n.defaultValue(e, n.defaultValue.EMPTY_OBJECT);
    e = n.defaultValue(e.vertexFormat, c.VertexFormat.DEFAULT);
    (this._vertexFormat = e), (this._workerName = "createPlaneGeometry");
  }
  (y.packedLength = c.VertexFormat.packedLength),
  ...
  var s = new c.VertexFormat(),
    A = { vertexFormat: s };
  y.unpack = function (e, t, r) {
    t = n.defaultValue(t, 0);
    t = c.VertexFormat.unpack(e, t, s);
    return n.defined(r)
      ? ((r._vertexFormat = c.VertexFormat.clone(t, r._vertexFormat)), r)
      : new y(A);
  };
  var l = new o.Cartesian3(-0.5, -0.5, 0),
    F = new o.Cartesian3(0.5, 0.5, 0);
  return (
    (y.createGeometry = function (e) {
      var t,
        r,
        n = e._vertexFormat,
        a = new p.GeometryAttributes();
      return (
        n.position &&
          (((e = new Float64Array(12))[0] = l.x),
          (e[1] = l.y),
          (e[2] = 0),
          (e[3] = F.x),
          (e[4] = l.y),
