    ...
    (c.createGeometry = function (e) {
      ...
      if (n === U.ArcType.GEODESIC || n === U.ArcType.RHUMB) {
        ...
        if (
          ...
          for (var g = 0, m = 0; m < c - 1; m++) g += u(a[m], a[m + 1], y) + 1;
          ...
          for (r = new Uint8Array((o.length / 3) * 4), m = 0; m < c - 1; ++m)
            f = (function (e, o, t, r, a, l, i) {
              ...
              for (
                ...
                (l[T++] = F.Color.floatToByte(s + g * y)),
                  ...
                  (l[T++] = F.Color.floatToByte(d + g * h)),
                  (l[T++] = F.Color.floatToByte(c + g * C));
              return T;
