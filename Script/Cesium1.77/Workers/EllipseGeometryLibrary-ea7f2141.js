define([
  ...
  function A(a, e, r, t, i, n, s, o, l, C) {
    ...
    V.Cartesian3.multiplyByScalar(t, Math.cos(e), u),
      V.Cartesian3.multiplyByScalar(r, Math.sin(e), m),
      V.Cartesian3.add(u, m, u);
    e = Math.cos(a);
    e *= e;
    a = Math.sin(a);
    a *= a;
    ...
    return (
      y.Quaternion.fromAxisAngle(u, a, c),
      y.Matrix3.fromQuaternion(c, h),
  ...
  e.raisePositionsToHeight = function (a, e, r) {
    for (
      ...
      var y = C + 1,
        u = C + 2,
        m = V.Cartesian3.fromArray(a, C, R);
      t.scaleToGeodeticSurface(m, m);
      var c = V.Cartesian3.clone(m, W),
        h = t.geodeticSurfaceNormal(m, M),
  ...
  (e.computeEllipsePositions = function (a, e, r) {
    var t = a.semiMinorAxis,
      ...
      m = V.Cartesian3.cross(V.Cartesian3.UNIT_Z, s, b),
      m = V.Cartesian3.normalize(m, m),
      c = V.Cartesian3.cross(u, m, Q),
    ...
    var f,
      ...
      P = A((M = E.CesiumMath.PI_OVER_TWO), n, c, m, o, C, l, y, u, P);
    for (
      ...
      if (
        ((P = A(M, n, c, m, o, C, l, y, u, P)),
        (T = A(Math.PI - M, n, c, m, o, C, l, y, u, T)),
        e)
      ) {
        for (
          p[w++] = P.x, p[w++] = P.y, p[w++] = P.z, _ = 2 * f + 2, z = 1;
          z < _ - 1;
          ++z
        )
          (d = z / (_ - 1)),
            (O = V.Cartesian3.lerp(P, T, d, S)),
            (p[w++] = O.x),
            (p[w++] = O.y),
            (p[w++] = O.z);
    ...
    for (f = h; 1 < f; --f) {
      if (
        ...
        (T = A(M + Math.PI, n, c, m, o, C, l, y, u, T)),
        e)
      ) {
        for (
          p[w++] = P.x, p[w++] = P.y, p[w++] = P.z, _ = 2 * (f - 1) + 2, z = 1;
          z < _ - 1;
          ++z
        )
          (d = z / (_ - 1)),
