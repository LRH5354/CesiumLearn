define([
  ...
  function c(e, t) {
    ...
    do {
      if (
        ((n = !1), r.steiner || (!p(r, r.next) && 0 !== w(r.prev, r, r.next)))
      )
        r = r.next;
      else {
                        ...
                        (function (e, t) {
                          return (
                            ...
                            ((b(e, t) &&
                              ...
                              (w(e.prev, e, t.prev) || w(e, t.prev, t))) ||
                              (p(e, t) &&
                                0 < w(e.prev, e, e.next) &&
                                0 < w(t.prev, t, t.next)))
                          );
  ...
  Z.computeSubdivision = function (e, t, n, r) {
    ...
    for (
      ...
      var y,
        ...
        w = G.Cartesian3.fromArray(u, 3 * c, B),
        b = G.Cartesian3.multiplyByScalar(G.Cartesian3.normalize(C, S), f, S),
        E = G.Cartesian3.multiplyByScalar(G.Cartesian3.normalize(g, A), f, A),
        M = G.Cartesian3.multiplyByScalar(G.Cartesian3.normalize(w, z), f, z),
        Z = G.Cartesian3.magnitudeSquared(G.Cartesian3.subtract(b, E, N)),
        E = G.Cartesian3.magnitudeSquared(G.Cartesian3.subtract(E, M, N)),
        M = G.Cartesian3.magnitudeSquared(G.Cartesian3.subtract(M, b, N)),
        b = Math.max(Z, E, M);
      l < b
        ? Z === b
  ...
  (Z.computeRhumbLineSubdivision = function (e, t, n, r) {
    ...
    for (
      ...
      var c = a.pop(),
        ...
        g = G.Cartesian3.fromArray(u, 3 * d, I),
        w = G.Cartesian3.fromArray(u, 3 * c, B),
        b = e.cartesianToCartographic(C, U),
        E = e.cartesianToCartographic(g, _),
        M = e.cartesianToCartographic(w, K);
      l.setEndPoints(b, E);
