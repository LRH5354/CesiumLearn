define([
  ...
  (i.prototype.computeHorizonCullingPointPossiblyUnderEllipsoid = function (
    ...
    return u(c(this._ellipsoid, i, s), t, e, r);
  }),
    ...
    (i.prototype.computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid = function (
      ...
      return C(c(this._ellipsoid, a, s), t, e, i, r, n);
    });
  var n = [];
  ...
  function C(t, e, i, r, a, n) {
    ...
    for (var o = P(t, e), s = 0, m = 0, c = i.length; m < c; m += r) {
      (x.x = i[m] + a.x), (x.y = i[m + 1] + a.y), (x.z = i[m + 2] + a.z);
      var u = M(t, x, o);
      if (u < 0) return;
      s = Math.max(s, u);
    }
  ...
  function w(t, e, i, r, a, n) {
    ...
    l.defined(t) &&
      ...
      ((c = t.minimum),
      (s = t.maximum),
      (u = p.Cartesian3.subtract(s, c, v)),
      (m = i - e),
      (d =
        Math.max(p.Cartesian3.maximumComponent(u), m) < _ - 1
          ? z.BITS12
          : z.NONE),
      (o = t.center),
      (s = h.Matrix4.inverseTransformation(r, new h.Matrix4())),
      (m = p.Cartesian3.negate(c, E)),
      h.Matrix4.multiply(h.Matrix4.fromTranslation(m, I), s, s),
      ((m = E).x = 1 / u.x),
      (m.y = 1 / u.y),
      (m.z = 1 / u.z),
      h.Matrix4.multiply(h.Matrix4.fromScale(m, I), s, s),
      (m = h.Matrix4.clone(r)),
      h.Matrix4.setTranslation(m, p.Cartesian3.ZERO, m),
      (r = h.Matrix4.clone(r, new h.Matrix4())),
      (c = h.Matrix4.fromTranslation(c, I)),
      (u = h.Matrix4.fromScale(u, B)),
      (u = h.Matrix4.multiply(c, u, I)),
      h.Matrix4.multiply(r, u, r),
      h.Matrix4.multiply(m, u, m)),
      (this.quantization = d),
    ...
    return (
      this.quantization === z.BITS12
        ? (((i = h.Matrix4.multiplyByPoint(
          ...
          (m = d.CesiumMath.clamp((a - this.minimumHeight) / s, 0, 1)),
          p.Cartesian2.fromElements(i.x, i.y, N),
          (r = f.AttributeCompression.compressTextureCoordinates(N)),
          p.Cartesian2.fromElements(i.z, m, N),
          (s = f.AttributeCompression.compressTextureCoordinates(N)),
          p.Cartesian2.fromElements(c, u, N),
          (m = f.AttributeCompression.compressTextureCoordinates(N)),
          (t[e++] = r),
          (t[e++] = s),
          (t[e++] = m),
