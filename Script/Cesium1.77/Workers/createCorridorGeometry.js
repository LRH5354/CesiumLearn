define([
  ...
  "./PolylineVolumeGeometryLibrary-0318616c",
  "./EllipsoidGeodesic-4cceb91b",
  "./PolylinePipeline-8e738866",
  "./CorridorGeometryLibrary-73694d0f",
], function (
  rt,
  t,
  at,
  ...
  function P(t, e, r) {
    ...
    for (
      ...
      if (((E = it.Cartesian3.fromArray(l, I, E)), rt.defined(B))) {
        for (
          gt(w, E, V, void 0, G, e), G -= 3, z = b, U = C, k = 0;
          k < B.length / 3;
          k++
        )
        ...
        for (
          gt(w, E, V, T, void 0, e), T += 3, z = C, U = b, k = 0;
          k < Y.length / 3;
          k++
        )
      ...
      (s = (function (t, e) {
        ...
        if (e.normal || e.bitangent || e.tangent) {
          for (
            ...
            var v = C + s,
              y = it.Cartesian3.fromArray(a, b, y),
              f = it.Cartesian3.fromArray(a, b + o, f),
              c = it.Cartesian3.fromArray(a, (b + 3) % o, c);
            (f = it.Cartesian3.subtract(f, y, f)),
              ...
              e.normal &&
                ...
                dt.CorridorGeometryLibrary.addAttribute(d, p, C),
                dt.CorridorGeometryLibrary.addAttribute(d, p, C + 3)),
              (e.tangent || e.bitangent) &&
                ((g = it.Cartesian3.fromArray(r, b, g)),
                e.bitangent &&
                  (dt.CorridorGeometryLibrary.addAttribute(m, g, v),
                  dt.CorridorGeometryLibrary.addAttribute(m, g, v + 3),
                  dt.CorridorGeometryLibrary.addAttribute(m, g, C),
                  dt.CorridorGeometryLibrary.addAttribute(m, g, C + 3)),
                e.tangent &&
                  ...
                  dt.CorridorGeometryLibrary.addAttribute(u, h, C),
                  dt.CorridorGeometryLibrary.addAttribute(u, h, C + 3))),
              (C += 6);
          }
          if (e.normal) {
            for (d.set(r), b = 0; b < o; b += 3)
              (d[b + o] = -r[b]),
                (d[b + o + 1] = -r[b + 1]),
                (d[b + o + 2] = -r[b + 2]);
            t.normal.values = d;
        ...
        if (e.st) {
          ...
          for (var w = 2 * n, T = 0; T < 2; T++) {
            for (_[w++] = A[0], _[w++] = A[1], b = 2; b < n; b += 2) {
              var G = A[b],
                E = A[b + 1];
  ...
  var h = new it.Cartesian3(),
    g = new it.Cartesian3(),
    C = new it.Cartographic();
  function b(t, e, r, a, i, o) {
    ...
    var d = i.latitude,
      ...
      e = o.latitude,
      n = o.longitude;
    it.Cartesian3.add(t, l, g), r.cartesianToCartographic(g, C);
    (s = C.latitude),
      (a = C.longitude),
      (d = Math.min(d, s)),
      (u = Math.min(u, a)),
  ...
  function d(t, e, r, a, i) {
    ...
    for (var u = 0; u < n - 1; ++u) b(o[u], o[u + 1], e, d, _, w);
    var m = o[n - 1];
