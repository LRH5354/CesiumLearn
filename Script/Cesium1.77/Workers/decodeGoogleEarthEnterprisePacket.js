              ...
              do {
                if (
                  (0 === s.avail_out &&
                    ...
                    (s.next_out = 0),
                    (s.avail_out = f)),
                  (i = u.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT &&
                    l &&
                    ((o =
                      "string" == typeof l
                        ? c.string2buf(l)
                        ...
                        ? new Uint8Array(l)
                        : l),
                    (i = u.inflateSetDictionary(this.strm, o))),
