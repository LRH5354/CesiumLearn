define([
  ...
  o.fromPointNormal = function (n, e, a) {
  ...
  (o.fromCartesian4 = function (n, e) {
    ...
    (o.getPointDistance = function (n, e) {
      return i.Cartesian3.dot(n.normal, e) + n.distance;
    });
  var c = new i.Cartesian3();
  o.projectPointOntoPlane = function (n, e, a) {
    r.defined(a) || (a = new i.Cartesian3());
    var t = o.getPointDistance(n, e),
      t = i.Cartesian3.multiplyByScalar(n.normal, t, c);
    return i.Cartesian3.subtract(e, t, a);
  };
  var f = new s.Matrix4(),
    l = new s.Cartesian4(),
    C = new i.Cartesian3();
  (o.transform = function (n, e, a) {
    var t = n.normal,
      n = n.distance,
      e = s.Matrix4.inverseTranspose(e, f),
    ...
    (o.ORIGIN_XY_PLANE = Object.freeze(new o(i.Cartesian3.UNIT_Z, 0))),
    (o.ORIGIN_YZ_PLANE = Object.freeze(new o(i.Cartesian3.UNIT_X, 0))),
    (o.ORIGIN_ZX_PLANE = Object.freeze(new o(i.Cartesian3.UNIT_Y, 0))),
    (n.Plane = o);
});
