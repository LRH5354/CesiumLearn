...
], function (e, y, t, f, P, k, C, w, b, A, c) {
  "use strict";
  function m(e, t, r) {
  ...
  function l(e) {
    ...
    for (d = u.length, g = 0; g < d; ++g) {
      ...
      if (a)
        for (f in h)
          h.hasOwnProperty(f) &&
            h[f].componentDatatype === k.ComponentDatatype.DOUBLE &&
  ...
  (h.combineGeometry = function (e) {
    ...
    0 < d &&
      ...
      y.defined(s[0].attributes) &&
        ...
        ((n = new Array(d)), (p = !0)));
    for (var u = new Array(d), f = new Array(d), c = 0; c < d; ++c) {
      var m = s[c],
        h = m.geometry;
      y.defined(h) &&
        ((u[c] = h.boundingSphere),
        (f[c] = h.boundingSphereCV),
        p && (n[c] = m.geometry.offsetAttribute));
      (h = m.eastHemisphereGeometry), (m = m.westHemisphereGeometry);
      y.defined(h) &&
        y.defined(m) &&
        (y.defined(h.boundingSphere) &&
          y.defined(m.boundingSphere) &&
          (u[c] = P.BoundingSphere.union(h.boundingSphere, m.boundingSphere)),
        y.defined(h.boundingSphereCV) &&
          y.defined(m.boundingSphereCV) &&
          (f[c] = P.BoundingSphere.union(
            h.boundingSphereCV,
            m.boundingSphereCV
          )));
    }
      ...
      for (var s = 0; s < o; s++) {
        ...
        if (((r[a++] = p ? 1 : 0), p)) {
          ...
          for (u in f)
            f.hasOwnProperty(u) &&
              y.defined(f[u]) &&
              (c.push(u), y.defined(i[u]) || ((i[u] = n.length), n.push(u)));
          r[a++] = c.length;
      ...
      for (
        ...
        if (1 === r[o++]) {
          ...
          -1 === u && (u = void 0),
            ...
            (o += P.BoundingSphere.packedLength);
          var f = new w.GeometryAttributes(),
            c = r[o++];
          for (S = 0; S < c; S++) {
            for (
              var m = t[r[o++]],
